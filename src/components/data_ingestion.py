...
from src.data_access.proj1_data import Vehicle_Data
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            logging.info(f"Saved exported data to feature store file path: {feature_store_file_path}")
